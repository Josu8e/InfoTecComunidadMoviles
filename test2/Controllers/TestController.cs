...
namespace test2.Controllers
{
    public class TestController : Controller
    {
        ...
        public JsonResult Departamentos(String nombre,string tipo,int idSede)////Consulta departamentos
        {

            return Json(
                    conexion.insertarDepartamento(nombre,tipo,idSede), JsonRequestBehavior.AllowGet);
        }
