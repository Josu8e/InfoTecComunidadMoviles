...
namespace test2.Controllers
{
    public class TestController : Controller
    {
        ...
        public JsonResult Departamentos(String nombre,String tipo,String encargado, String codigoDep, String sede)////Consulta departamentos
        {

            return Json(
                    conexion.insertarDepartamento(nombre,tipo, encargado, codigoDep, sede), JsonRequestBehavior.AllowGet);
        }
