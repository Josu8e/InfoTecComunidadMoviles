...
function EnviarMensajeDinamico() {
    ...
    obtenerDepartamentos(function carrerasDinamicas() {
        ...
        for (i = 0; i < listaDepartamentos.length; i++) {
            texto += '<div class="bg" id="n' + i + '" style= "visibility:hidden;"> <div class="cosa1">' + listaDepartamentos[i].nombre + ' - ' + listaDepartamentos[i].codigoDep + ': </div> <div class="cosa2"> <label class="switch-light switch-candy"> <input type="checkbox" id="' + listaDepartamentos[i].codigoDep + '"> <span> <span>No</span> <span>Si</span> <a></a> </span> </label> </div> </div>';
        }
        texto += '</p>';
